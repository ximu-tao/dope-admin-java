...
public interface AppMyInfoController<S extends BaseService<T>, T extends BaseEntity<T>> extends IController<S, T> {

    @Operation(summary = "我的数据详情", description = "")
    @PostMapping("/myInfo")
    default R<T> myInfo(@Valid @RequestBody OneParams oneParams) {
