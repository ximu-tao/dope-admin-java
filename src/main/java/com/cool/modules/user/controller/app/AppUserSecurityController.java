...
import com.cool.core.base.OnlyOneControllerAdapter;
...
@CoolRestController(api = { Apis.MY_INFO })
public class AppUserSecurityController extends OnlyOneControllerAdapter<UserSecurityService, UserSecurityEntity> {
    @Override
